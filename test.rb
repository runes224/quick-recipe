...
a.dropdown - item href = "#" 経営理念
a.dropdown - item href = "#" 会社概要
a.dropdown - item href = "#" アクセス
a.dropdown - item href = "#" 採用情報
...
-if user_signed_in?
   ...
   li.dropdown.open
     .dropdown - toggle.text - white[href = "#" data - toggle = "dropdown" aria - haspopup = "true" aria - expanded = "false"] アカウント
   ul.dropdown - menu
   li
